...
<body class="container"
	...
	<div class="container-fluid my-4">
		<div
			...
			<div class="col-6">
				<h1 class="featurette-heading">About Moment Craft </h1>
				<p>At Moment Craft Events, we are passionate about creating
			...
			<div class="col-6">
				<img class="img-fluid" style="height: 400px; width: 1000px;" alt=""
					src="https://i.pinimg.com/474x/48/28/ab/4828ab23c8412ad6ae0b43a2b139a766.jpg">
			</div>
		</div>
		<div
			class="row featurette d-flex justify-content-center align-items-center">
			<div class="col-6 order-2">
				...
				<p>At Moment Craft, our vision is to be the premier provider of
			...
			<div class="col-6 order-1">
				<img class="img-fluid" style="height: 400px; width: 100%;"
					src="https://i.pinimg.com/474x/05/43/a1/0543a137cd925e8dfdfecb9963e2e659.jpg"
					alt="">
			</div>
		</div>
		<div
			...
			<div class="col-md-6">
				...
				<p>At Moment Craft Events, our vision is to be the premier provider of
					exceptional event experiences that leave a lasting impact. We
					believe that every event has the power to create memories, inspire
					connections, and bring people together in meaningful ways.</p>
				<p>Our vision is fueled by a deep passion for creativity,
			...
			<div class="col-md-6">
				<img class="img-fluid" style="height: 400px; width: 900px;"
					src="https://i.pinimg.com/474x/a1/f1/13/a1f113bf09c57daf0eed2e920b0f0a96.jpg"
					alt="">
			</div>
		</div>
	</div>
