	...
	<div class="categories">
		<div class="small-container">
			<div class="container-fluid text-center pt-4 pb-4"
				style="background-color: #d9a5b3; color:white;  box-shadow: rgba(0, 0, 0, 0.1) 0px 5px 15px;">
			...
			<div class="row">
				<div class="col-3">
					<a class="text-success"
						href="events.jsp?event_category=<%=s.getEvent_category()%>"><img
						src="<%=s.getEvent_img()%>"><br><%=s.getEvent_category()%></a>
				</div>
				<%
				}
				%>
