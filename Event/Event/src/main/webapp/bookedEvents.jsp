...
<body class="container"
	style="background-color:#fbcbc9; font-style: inherit; color: rgb(99, 118, 84);">
	<div class="header">
		<div class="container">
		...
		<div class="table-responsive">
			<div class="table-wrapper">
				<div class="container-fluid"
					style="background-color:#d9a5b3; width: 1090px; height: 67px; margin-left: -23px; margin-top: -20px; font-style: inherit; color: white;">
					<div class="row">
						<div class="col-sm-4">
