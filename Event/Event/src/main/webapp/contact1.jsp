...
<body class="container"
	style="background-color: #f1f8e9; font-style: inherit; color: #F9F4F5;">
	<script>
		...
		<div id="contact" class="w-50">
			<div class="row">
				<div>
					...
					<h1 class="d-inline display-4 m-3" style="color: #F9F4F5;">Contact Us</h1>
				</div>
				<div class="text-start me-5 p-5">
					<p >Thank you for considering our event management
					...
					<p class="me-5">
						<span >Office Address:</span> Plot No.765,8th
						Cross Road, M.R.C.R Extension, Govindaraja Nagar, Bangalore-560040
						(Near Hosahalli metro station)
					</p>
					<p class="me-5">
						<span >Contact Number: </span> +91 9916012459
					</p>
					<p class="me-5">
						<span >Mail ID: </span> momemtcraft@gmail.com
					</p>
				</div>
